...
CREATE TABLE `solicitacoes_hae` (
  ...
  `categoria` enum('Administrativo','Acadêmico','Extensão a comunidade') NOT NULL,
...
(1, 1, '12/04/2011', 3, 'Relacionamentos com empresas de TI.', 0, NULL, 'Realizar o relacionamento junto às empresas de TI, a fim de tornar a Fatec Garça mais conhecida e buscar junto a estas parcerias, apoio para a unidade e fortalecimento dos cursos.', 24, 12, 8, 44, 198, 'Administrativo', 'Buscar junto a empresas de tecnologia da informação uma integração (Faculdade x Empresas) proporcionando ganhos de conhecimentos e troca de experiências para as partes. ', 'Realizar o relacionamento junto às empresas de TI, tornando a Fatec Garça mais conhecida e buscar junto a estas parcerias, apoio para a unidade e fortalecimento dos cursos.', 'Este relacionamento acontecerá através de visitas e reuniões entre as partes, tanto na unidade de ensino como nas empresas.', 'Professor, Direção e Empresas de TI.', 'Físico,Humano', '', 'As atividades irão transcorrer nos meses que compreende o segundo semestre do ano de 2024.', 'Conseguir agregar benefícios para a Fatec Garça e para as empresas de TI.', 'Aprovado', '2026-05-05 19:45:28'),
(2, 3, '12/04/2026', 4, 'Relacionamentos com empresas de TI.', 0, NULL, 'wersdtfygukfdbsvca\\', 24, 12, 8, 44, 198, 'Acadêmico', 'AFSGDHTFUKJL,JMGHNFBVZC\\Xz', 'ewgrehtryjuiloç,gjfmhdnsbacfsbfbf fsdgjfyu', 'wshrderty sfjdesrdtfy easrdtfy dzxfcfg', 'wertjy qWAESRYKTU ', 'Físico,Humano', 'ERTTIYOIYLTDSHJYKUIL HRJYKUFIL, ', 'MARCO A JULHO DE 2025', 'SFDJTFRYTOYUPO AGDSZDHXFCJGKHegty', 'Aprovado', '2026-05-05 22:13:35');
