...
<body>
    ...
    <main class="main-content">
        ...
        <div class="print-header">
            ...
            <p>Professores com relatórios pendentes referentes ao período de: <strong>
                    <?php echo $meses[$mes_alvo] . ' / ' . $ano_alvo; ?>
                </strong></p>
            <p>Data de geração do documento:
                <?php echo date('d/m/Y H:i'); ?>
            </p>
        </div>

        <div
            style="background: #fff; padding: 30px; border-radius: 10px; border-top: 5px solid var(--fatec-red); box-shadow: 0 4px 15px rgba(0,0,0,0.03);">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                <div>
                    <h2 style="font-size: 20px; color: #333; margin-bottom: 5px;">Relatório de Pendências:
                        <?php echo $meses[$mes_alvo] . ' / ' . $ano_alvo; ?>
                    </h2>
                    <p style="color: #666; font-size: 14px;">Lista de docentes que não submeteram os relatórios no
                        portal até a data limite (Dia 10).</p>
                </div>
                ...
                <table class="tabela-inadimplentes">
                    ...
                    <tbody>
                        <?php foreach ($inadimplentes as $ind): ?>
                            <tr>
                                <td><strong>
                                        <?php echo htmlspecialchars($ind['professor_nome']); ?>
                                    </strong></td>
                                <td>
                                    <?php echo htmlspecialchars($ind['titulo_projeto']); ?>
                                </td>
                                <td>
            ...
            <?php else: ?>
                <div
                    style="background: #f4fbf7; padding: 30px; text-align: center; border-radius: 8px; border: 1px solid #d1e7dd; margin-top: 20px;">
                    ...
                    <p style="color: #666; font-size: 14px;">Todos os relatórios referentes a
                        <?php echo $meses[$mes_alvo] . ' / ' . $ano_alvo; ?> foram entregues dentro do prazo.
                    </p>
                </div>
            <?php endif; ?>
